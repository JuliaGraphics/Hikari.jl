# CIE XYZ Color Matching Functions and Spectral-to-RGB Conversion
# Based on pbrt-v4 implementation in util/spectrum.cpp and film.h
...
# Sampled from 360nm to 830nm at 1nm intervals
# =============================================================================
...
# =============================================================================
# Spectral to XYZ/RGB Conversion (matching pbrt-v4)
# =============================================================================
...
The formula is:
    XYZ = (1/CIE_Y_integral) * Average(SafeDiv(CMF * L, pdf))
...
"""
    linear_to_srgb_gamma(c::Float32) -> Float32
...
@propagate_inbounds function linear_to_srgb_gamma(c::Float32)::Float32
    if c <= 0.0031308f0
        ...
        return 1.055f0 * c^(1.0f0/2.4f0) - 0.055f0
    end
end

"""
    srgb_gamma_to_linear(c::Float32) -> Float32
...
@propagate_inbounds function srgb_gamma_to_linear(c::Float32)::Float32
    if c <= 0.04045f0
        ...
        return ((c + 0.055f0) / 1.055f0)^2.4f0
    end
end
